  ...
  return (
    <aside className="sticky top-0 flex h-screen w-[280px] shrink-0 flex-col bg-sidebar text-slate-100">
      <div className="border-b border-slate-800 px-6 py-7">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-lg leading-tight text-slate-300">Stock Intake System</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-auto space-y-2 px-6 py-5">
        ...
        <button onClick={logout} className="flex items-center gap-3 text-base text-slate-100 transition hover:text-white">
